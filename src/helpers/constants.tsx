/*
Ported from python to javascript from here
https://github.com/scipag/btle-sniffer/blob/master/src/btlesniffer/hci_constants.py
*/
// added new constants from bluetooth sig:
...
const ALL_16BIT_UUIDS = {
  ...
  0x2b92: "Time Change Log Data 0x2B93 Media Player Name",
  0x2b94: "Media Player Icon Object ID",
  0x2b95: "Media Player Icon URL 0x2B96 Track Changed",
  0x2b97: "Track Title",
...
const uuidToString = (uuid: string): string | null => {
  ...
  const uuidText =
    uuid in ALL_128BIT_UUIDS ? ALL_128BIT_UUIDS[uuid as keyof typeof ALL_128BIT_UUIDS] : "";
  if (uuidText) {
    return uuidText;
  }
  ...
  console.log(`uuid_text_128 for ${uuid}:${uuidText}`);
  return null;
};
